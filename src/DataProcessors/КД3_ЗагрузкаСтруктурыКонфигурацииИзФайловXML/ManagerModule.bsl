...
Процедура ПрочитатьДанныеОКонфигурации(ОбщиеПеременные)
	...
	КонецЕсли;
	ИмяФайлаСведений = НайтиПомещенныеФайлыПоИмени(ОбщиеПеременные.ПомещенныеФайлы, ИмяФайлаДляПоиска);
...
Процедура ПрочитатьСведенияОСвойствахИзXML(ЧтениеXML, ДанныеОбъекта, ОбщиеПеременные)
	...
	Если ДанныеОбъекта.ТипОбъекта = Перечисления.ТипыОбъектов.Справочник
		...
		ФайлСПредопределенными = НайтиПомещенныеФайлыПоИмени(ОбщиеПеременные.ПомещенныеФайлы, ПутьКПредопределенным);
	...
	ИначеЕсли ДанныеОбъекта.ТипОбъекта = Перечисления.ТипыОбъектов.ПланОбмена Тогда
		...
		ФайлССоставом = НайтиПомещенныеФайлыПоИмени(ОбщиеПеременные.ПомещенныеФайлы, ПутьКСоставу);
...
Функция НайтиПомещенныеФайлыПоИмени(ПомещенныеФайлы, ИмяФайла)
	Результат = "";
