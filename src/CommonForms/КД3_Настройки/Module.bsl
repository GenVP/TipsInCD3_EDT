...
Процедура ЗагрузитьКонсольКодаИзФайла(Команда)
	...
	НастройкиДиалога.Вставить("Заголовок", НСтр("ru='Выберите файл с архивим исходного кода исходников'"));
...
Процедура ЗагрузитьКонсольКодаИзФайлаЗавершение(РезультатПомещенияФайлов, ДопПараметры) Экспорт
	...
	КД3_Настройки.УстановитьФайлМакетаИсходников(АдресФайлаЗагрузки);
	КД3_НастройкиКлиент.УдалитьИсходники();
	ОбновитьИнформациюПоКонсолиКода();
