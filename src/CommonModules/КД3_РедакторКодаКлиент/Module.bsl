...
#Если НЕ ВебКлиент Тогда
	ВерсияРедактораКода = КД3_Настройки.ВерсияКонсолиКода();
	...
	Если НЕ ТестФайл.Существует() Тогда
		...
		ДвоичныеДанные = ПолучитьИзВременногоХранилища(КД3_Настройки.ДвоичныеДанныеКонсолиКода());
		ZipФайл = Новый ЧтениеZipФайла(ДвоичныеДанные.ОткрытьПотокДляЧтения());
		ZipФайл.ИзвлечьВсе(КаталогИсходников);
		ДобавитьМетодыВИсходники(КаталогИсходников);
...
//
Процедура ДобавитьМетодыВИсходники(КаталогИсходников)
